...
(def raw-metadata-str
  "<versionList moduleCategory='Deployment' moduleName='examples/tutorials/wordpress/wordpress'>
    <item category='Deployment' lastModified='2014-04-10 12:15:41.121 UTC' name='wordpress' moduleName='examples/tutorials/wordpress/wordpress' resourceUri='module/examples/tutorials/wordpress/wordpress/180' version='180'>
    ...
    <item category='Deployment' lastModified='2014-05-10 14:57:23.511 UTC' name='wordpress' moduleName='examples/tutorials/wordpress/wordpress' resourceUri='module/examples/tutorials/wordpress/wordpress/478' version='478'>
        <authz groupCreateChildren='false' groupDelete='false' groupGet='true' groupPost='true' groupPut='false' inheritedGroupMembers='true' owner='sixsq' ownerCreateChildren='true' ownerDelete='true' ownerGet='true' ownerPost='true' ownerPut='true' publicCreateChildren='false' publicDelete='false' publicGet='true' publicPost='true' publicPut='false'>
            <groupMembers class='java.util.ArrayList'/>
        </authz>
        <commit author='sixsq'>
    ...
    <item category='Deployment' lastModified='2014-05-04 12:36:13.579 UTC' name='wordpress' moduleName='examples/tutorials/wordpress/wordpress' resourceUri='module/examples/tutorials/wordpress/wordpress/318' version='318'>
    ...
    <item category='Deployment' lastModified='2013-12-02 16:57:09.999 UTC' name='wordpress' moduleName='examples/tutorials/wordpress/wordpress' resourceUri='module/examples/tutorials/wordpress/wordpress/74' version='74'>
...
(def parsed-metadata
  {:versions [{:version 74
   ...
   :module-short-name "wordpress"
   :module-name "examples/tutorials/wordpress/wordpress"
