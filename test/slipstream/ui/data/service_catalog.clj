  ...
  (first (html/html-snippet "<serviceCatalogues>
      ...
      <serviceCatalog deleted='false' resourceUri='servicecatalog/toto' cloud='toto' creation='2013-11-12 20:21:20.98 CET'>
         <parameters class='org.hibernate.collection.PersistentMap'>
            <entry>
               <string><![CDATA[support.email]]></string>
               <parameter class='com.sixsq.slipstream.persistence.ServiceCatalogParameter' name='toto.support.email' description='Support email adress for this cloud service' mandatory='true' type='String' readonly='false' category='General'>
                  <instructions><![CDATA[]]></instructions>
            ...
            <entry>
               <string><![CDATA[overall.ram]]></string>
               <parameter class='com.sixsq.slipstream.persistence.ServiceCatalogParameter' name='toto.overall.ram' description='Overall available RAM' mandatory='true' type='String' readonly='false' category='Overall'>
                  <instructions><![CDATA[]]></instructions>
                  <value><![CDATA[]]></value>
               </parameter>
            </entry>
            <entry>
               <string><![CDATA[overall.cpu]]></string>
               <parameter class='com.sixsq.slipstream.persistence.ServiceCatalogParameter' name='toto.overall.cpu' description='Overall available CPUs (cores)' mandatory='true' type='String' readonly='false' category='Overall'>
                  <instructions><![CDATA[]]></instructions>
                  <value><![CDATA[]]></value>
               </parameter>
            </entry>
            <entry>
               <string><![CDATA[single.vm.max.ram]]></string>
               <parameter class='com.sixsq.slipstream.persistence.ServiceCatalogParameter' name='toto.single.vm.max.ram' description='Maximum number of RAM (GB) for a single VM' mandatory='true' type='String' readonly='false' category='Single_VM'>
                  <instructions><![CDATA[]]></instructions>
                  <value><![CDATA[]]></value>
               </parameter>
            </entry>
            <entry>
               <string><![CDATA[general.description]]></string>
               <parameter class='com.sixsq.slipstream.persistence.ServiceCatalogParameter' name='toto.general.description' description='General description of the cloud service (including optional further links)' mandatory='true' type='String' readonly='false' category='General'>
                  <instructions><![CDATA[]]></instructions>
                  <value><![CDATA[]]></value>
               </parameter>
            </entry>
