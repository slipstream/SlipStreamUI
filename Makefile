...
repl:
	...
	$(info )
	$(info If the test server starts correctly, you'll find test pages at port 8080:)
	$(info )
	$(info  http://localhost:8080/login )
	$(info  http://localhost:8080/welcome )
	$(info  http://localhost:8080/image-view )
	$(info )
