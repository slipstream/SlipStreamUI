...
(def parsed-medatada
  {:parameters [{:category-type :global
                 ...
                 :parameters [{:help-hint "URL should point to a valid gzipped tarball.", :read-only? false, :order 2147483647, :value "http://slipstream.sixsq.com/libcloud.tgz", :category "SlipStream_Advanced", :description "URL to fetch libcloud library from", :type "String", :name "cloud.connector.library.libcloud.url"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "/opt/slipstream/server/.ssh/id_rsa.pub", :category "SlipStream_Advanced", :description "SSH public key used for orchestrator", :type "String", :name "cloud.connector.security.publicsshkey"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "$HeadURL: https://code.sixsq.com/svn/SlipStream/trunk/SlipStreamServer/src/main/resources/com/sixsq/slipstream/main/default.config.properties $", :category "SlipStream_Advanced", :description "", :type "String", :name "slipstream.headurl"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "/var/tmp/slipstream/reports", :category "SlipStream_Advanced", :description "", :type "String", :name "slipstream.reports.location"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "https://212.159.217.20/downloads/slipstream.bootstrap", :category "SlipStream_Advanced", :description "Endpoint of the SlipStream client bootstrap script", :type "String", :name "slipstream.update.clientbootstrapurl"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "https://212.159.217.20/downloads/slipstreamclient.tgz", :category "SlipStream_Advanced", :description "Endpoint of the SlipStream client tarball", :type "String", :name "slipstream.update.clienturl"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "1.7", :category "SlipStream_Advanced", :description "Installed SlipStream version", :type "String", :name "slipstream.version", :editable? false}]}
                {:category-type :global
                 :category "SlipStream_Basics"
                 :parameters [{:help-hint nil, :read-only? false, :order 2147483647, :value "atos:com.sixsq.slipstream.connector.stratuslab.StratusLabConnector,interoute:com.sixsq.slipstream.connector.abiquo.AbiquoConnector,com.sixsq.slipstream.connector.cloudsigma.CloudSigmaConnector", :category "SlipStream_Basics", :description "Cloud connector java class name(s) (comma separated for multi-cloud configuration)", :type "Text", :name "cloud.connector.class"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "https://212.159.217.20", :category "SlipStream_Basics", :description "Default URL and port for the SlipStream RESTlet", :type "String", :name "slipstream.base.url"}]}
                {:category-type :global
                 :category "SlipStream_Support"
                 :parameters [{:help-hint nil, :read-only? false, :order 2147483647, :value true, :category "SlipStream_Support", :description "Debug mail sending.", :type "Boolean", :name "slipstream.mail.debug"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "smtp.gmail.com", :category "SlipStream_Support", :description "Host for SMTP server for email notifications.", :type "String", :name "slipstream.mail.host"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "b,cysa10", :category "SlipStream_Support", :description "Password for SMTP server.", :type "Password", :name "slipstream.mail.password"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "465", :category "SlipStream_Support", :description "Port on SMTP server (defaults to standard ports).", :type "String", :name "slipstream.mail.port"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value true, :category "SlipStream_Support", :description "Use SSL for SMTP server.", :type "Boolean", :name "slipstream.mail.ssl"}
                              {:help-hint "Username of the mail server account used to send registration emails.", :read-only? false, :order 2147483647, :value "mailer@sixsq.com", :category "SlipStream_Support", :description "Username for SMTP server.", :type "String", :name "slipstream.mail.username"}
                              {:help-hint "<h1>email address</h1> to use for registration", :read-only? false, :order 2147483647, :value "register@sixsq.com", :category "SlipStream_Support", :description "Email address for account approvals, etc.", :type "String", :name "slipstream.registration.email"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "slipstream-support@sixsq.com", :category "SlipStream_Support", :description "Email address for SlipStream support requests", :type "String", :name "slipstream.support.email"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "http://www.sixsq.com/support", :category "SlipStream_Support", :description "URL where support can be obtained.", :type "String", :name "slipstream.support.url"}]}
                {:category-type :global
                 :category "atos"
                 :parameters [{:help-hint nil, :read-only? false, :order 2147483647, :value "atos-cloud.sixsq.com", :category "atos", :description "Service endpoint for atos", :type "String", :name "atos.cloud.connector.endpoint"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "http://marketplace.stratuslab.eu", :category "atos", :description "Marketplace endpoint", :type "String", :name "atos.cloud.connector.marketplace.endpoint"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "eu-west-1.queue.amazonaws.com", :category "atos", :description "Messaging endpoint", :type "String", :name "atos.cloud.connector.messaging.endpoint"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "/571976520084/slipstream_stratuslab_hn/", :category "atos", :description "Messaging queue", :type "String", :name "atos.cloud.connector.messaging.queue"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "amazonsqs", :category "atos", :description "Messaging type: amazaonsqs, rest, dirq", :type "String", :name "atos.cloud.connector.messaging.type"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "HZTKYZgX7XzSokCHMB60lS0wsiv", :category "atos", :description "Image Id of the orchestrator for atos", :type "String", :name "atos.cloud.connector.orchestrator.imageid"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "t1.micro", :category "atos", :description "Orchestrator instance type", :type "String", :name "atos.cloud.connector.orchestrator.instance.type"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "https://212.159.217.20/downloads/stratuslabclient.tgz", :category "atos", :description "URL with the cloud client specific connector", :type "String", :name "atos.cloud.connector.update.clienturl"}]}
                {:category-type :global
                 :category "cloudsigma"
                 :parameters [{:help-hint nil, :read-only? false, :order 2147483647, :value "ZRH", :category "cloudsigma", :description "Location: LVS, ZRH", :type "String", :name "cloudsigma.cloud.connector.location"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "5236b9ee-f735-42fd-a236-17558f9e12d3", :category "cloudsigma", :description "Image Id of the orchestrator for cloudsigma", :type "String", :name "cloudsigma.cloud.connector.orchestrator.imageid"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "1,1,1", :category "cloudsigma", :description "Orchestrator instance size. (MEM(GB),#SMP,CPU(GHz))", :type "String", :name "cloudsigma.cloud.connector.orchestrator.instance.type"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "ubuntupass", :category "cloudsigma", :description "Orchestrator SSH password", :type "Password", :name "cloudsigma.cloud.connector.orchestrator.ssh.password"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "root", :category "cloudsigma", :description "Orchestrator SSH username", :type "String", :name "cloudsigma.cloud.connector.orchestrator.ssh.username"}]}
                {:category-type :global
                 :category "ec2"
                 :parameters [{:help-hint nil, :read-only? false, :order 2147483647, :value "us-east-1:ami-4bf63722", :category "ec2", :type "String", :name "ec2.cloud.connector.orchestrator.imageid"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "t1.micro", :category "ec2", :type "String", :name "ec2.cloud.connector.orchestrator.instance.type"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "https://212.159.217.20/downloads/awsclient.tgz", :category "ec2", :type "String", :name "ec2.cloud.connector.update.clienturl"}]}
                {:category-type :global
                 :category "interoute"
                 :parameters [{:help-hint nil, :read-only? false, :order 2147483647, :value "http://vdcbridge.interoute.com/jclouds/api", :category "interoute", :description "Service endpoint for interoute", :type "String", :name "interoute.cloud.connector.endpoint"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "SS_ORCH_UBUNTU1204", :category "interoute", :description "Image Id of the orchestrator for interoute", :type "String", :name "interoute.cloud.connector.orchestrator.imageid"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "1,1", :category "interoute", :description "Orchestrator instance size. (#CPUs,RAM(GB))", :type "String", :name "interoute.cloud.connector.orchestrator.instance.type"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "rootpass", :category "interoute", :description "Orchestrator SSH password", :type "Password", :name "interoute.cloud.connector.orchestrator.ssh.password"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "root", :category "interoute", :description "Orchestrator SSH username", :type "String", :name "interoute.cloud.connector.orchestrator.ssh.username"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "https://212.159.217.20/downloads/libcloud.tgz", :category "interoute", :description "URL with the cloud client specific connector", :type "String", :name "interoute.cloud.connector.update.clienturl"}]}
                {:category-type :global
                 :category "openstack"
                 :parameters [{:help-hint nil, :read-only? false, :order 2147483647, :value "682f990d-7c90-4762-8344-95197ba0f81c", :category "openstack", :type "String", :name "openstack.cloud.connector.orchestrator.imageid"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "m1.tiny", :category "openstack", :type "String", :name "openstack.cloud.connector.orchestrator.instance.type"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "nova", :category "openstack", :type "String", :name "openstack.cloud.connector.service.name"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "RegionOne", :category "openstack", :type "String", :name "openstack.cloud.connector.service.region"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "compute", :category "openstack", :type "String", :name "openstack.cloud.connector.service.type"}]}
                {:category-type :global
                 :category "physicalhost"
                 :parameters [{:help-hint nil, :read-only? false, :order 2147483647, :value "localhost", :category "physicalhost", :type "String", :name "physicalhost.cloud.connector.orchestrator.host"}]}
                {:category-type :global
                 :category "stratuslab"
                 :parameters [{:help-hint nil, :read-only? false, :order 2147483647, :value "cloud.lal.stratuslab.eu", :category "stratuslab", :type "String", :name "stratuslab.cloud.connector.endpoint"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "http://marketplace.stratuslab.eu", :category "stratuslab", :type "String", :name "stratuslab.cloud.connector.marketplace.endpoint"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "eu-west-1.queue.amazonaws.com", :category "stratuslab", :type "String", :name "stratuslab.cloud.connector.messaging.endpoint"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "/571976520084/slipstream_stratuslab_hn/", :category "stratuslab", :type "String", :name "stratuslab.cloud.connector.messaging.queue"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "amazonsqs", :category "stratuslab", :type "String", :name "stratuslab.cloud.connector.messaging.type"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "HZTKYZgX7XzSokCHMB60lS0wsiv", :category "stratuslab", :type "String", :name "stratuslab.cloud.connector.orchestrator.imageid"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "t1.micro", :category "stratuslab", :type "String", :name "stratuslab.cloud.connector.orchestrator.instance.type"}
                              {:help-hint nil, :read-only? false, :order 2147483647, :value "https://212.159.217.20/downloads/stratuslabclient.tgz", :category "stratuslab", :type "String", :name "stratuslab.cloud.connector.update.clienturl"}]}]})
