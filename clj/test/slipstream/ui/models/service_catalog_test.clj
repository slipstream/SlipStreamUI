...
(def raw-metadata-str
  "<serviceCatalogs>
   ...
   <user issuper=\"true\" name=\"rob\" resourceUri=\"user/rob\"/>
  <serviceConfiguration creation=\"2014-12-16 08:49:13.504 CET\" deleted=\"false\">
...
(def parsed-metadata
  {:items [{:cloud "Exoscale"
            ...
            :parameters [{:help-hint nil, :read-only? true, :order 0, :value "asdf", :category "Locations", :description "Nature: geographical location of relevant data centre(s); Value: ISO-standard country code and name for cloud location and operational company location, e.g. NL The Netherlands; Explanation: currently, data protection legislation differs per country", :type "String", :name "Exoscale.location"}
                         {:help-hint "Value: an integer, and possibly approximate, number, e.g. 1,000; Explanation: to give an indication of the scale of the environment available for use", :read-only? true, :order 0, :value nil, :category "Overall capacity", :description "The number of CPU cores (currently) available within (the relevant part of) the supplier’s IaaS environment", :type "String", :name "Exoscale.overall.capacity.cpu"}
                         {:help-hint nil, :read-only? true, :order 0, :value nil, :category "Overall capacity", :description "Nature: the amount of random-access memory in total; Value: expressed in relevant terms, e.g. 10 TB; Explanation: the amount of memory available across the installation as a whole. See below for what is available on any one system", :type "String", :name "Exoscale.overall.capacity.ram"}
                         {:help-hint nil, :read-only? true, :order 0, :value nil, :category "Overall capacity", :description "Nature: the amount of persistent storage (e.g. SSD, disk, tape) available within that supplier’s environment; Value: expressed in relevant terms, e.g. 10 PB; Explanation: possibly multiple values, e.g. per technology type", :type "String", :name "Exoscale.overall.capacity.storage"}
                         {:help-hint nil, :read-only? true, :order 0, :value nil, :category "Price", :description "Nature: the period used for charging; Value: the pricing period, e.g. hour, month; Explanation: this could vary per resource, e.g. CPU per hour, storage per month", :type "String", :name "Exoscale.price.charging.period"}
                         {:help-hint nil, :read-only? true, :order 0, :value nil, :category "Price", :description "Nature: the unit used for charging; Value: the pricing unit, e.g. GHz, portion of CPU chip, etc.; Explanation: this could vary per supplier, as there is no standard unit. Work from the ODCA or Deutsche Boerse could be used to derive such a standard, at least for comparative purposes, in the future", :type "String", :name "Exoscale.price.charging.unit"}
                         {:help-hint nil, :read-only? true, :order 0, :value nil, :category "Price", :description "Nature: the price for use of a unit of processing per period, e.g. hour; Value: the price in euros, e.g. €0.05", :type "String", :name "Exoscale.price.cpu.per.hour"}
                         {:help-hint nil, :read-only? true, :order 0, :value nil, :category "Price", :description "Nature: the price for transmitting a unit (e.g. 1 GB) in or out of the environment; Value: the price in euros, e.g. €0.30", :type "String", :name "Exoscale.price.io"}
                         {:help-hint nil, :read-only? true, :order 0, :value nil, :category "Price", :description "Nature: the price for use of a unit (e.g. 1 GB) of memory per hour; Value: the price in euros, e.g. €0.05", :type "String", :name "Exoscale.price.ram.per.hour"}
                         {:help-hint nil, :read-only? true, :order 0, :value nil, :category "Price", :description "Nature: the price for use of a unit (e.g. 1 GB) of storage per hour; Value: the price in euros, e.g. €0.0005; Explanation: note that is possible that storage is either associated with a particular VM or as a generally-available resource", :type "String", :name "Exoscale.price.storage.per.hour"}
                         {:help-hint nil, :read-only? true, :order 0, :value nil, :category "Single VM capacity", :description "Nature: the maximum number of CPU cores with which this supplier’s  VMs can be configured; Value: an integer number, e.g. 8; Explanation: to give an indication of the maximum configurable environment", :type "String", :name "Exoscale.single.vm.max.cpu"}
           ...
           {:cloud "StratusLab"
            ...
            :parameters [{:help-hint nil, :read-only? true, :order 0, :value nil, :category "Locations", :description "Nature: geographical location of relevant data centre(s); Value: ISO-standard country code and name for cloud location and operational company location, e.g. NL The Netherlands; Explanation: currently, data protection legislation differs per country", :type "String", :name "StratusLab.location"}
                         ...
                         {:help-hint nil, :read-only? true, :order 0, :value nil, :category "Price", :description "Nature: the period used for charging; Value: the pricing period, e.g. hour, month; Explanation: this could vary per resource, e.g. CPU per hour, storage per month", :type "String", :name "StratusLab.price.charging.period"}
                         {:help-hint nil, :read-only? true, :order 0, :value nil, :category "Price", :description "Nature: the unit used for charging; Value: the pricing unit, e.g. GHz, portion of CPU chip, etc.; Explanation: this could vary per supplier, as there is no standard unit. Work from the ODCA or Deutsche Boerse could be used to derive such a standard, at least for comparative purposes, in the future", :type "String", :name "StratusLab.price.charging.unit"}
                         {:help-hint nil, :read-only? true, :order 0, :value nil, :category "Price", :description "Nature: the price for use of a unit of processing per period, e.g. hour; Value: the price in euros, e.g. €0.05", :type "String", :name "StratusLab.price.cpu.per.hour"}
                         {:help-hint nil, :read-only? true, :order 0, :value nil, :category "Price", :description "Nature: the price for transmitting a unit (e.g. 1 GB) in or out of the environment; Value: the price in euros, e.g. €0.30", :type "String", :name "StratusLab.price.io"}
                         {:help-hint nil, :read-only? true, :order 0, :value nil, :category "Price", :description "Nature: the price for use of a unit (e.g. 1 GB) of memory per hour; Value: the price in euros, e.g. €0.05", :type "String", :name "StratusLab.price.ram.per.hour"}
                         {:help-hint nil, :read-only? true, :order 0, :value nil, :category "Price", :description "Nature: the price for use of a unit (e.g. 1 GB) of storage per hour; Value: the price in euros, e.g. €0.0005; Explanation: note that is possible that storage is either associated with a particular VM or as a generally-available resource", :type "String", :name "StratusLab.price.storage.per.hour"}
                         ...
                         {:help-hint nil, :read-only? true, :order 0, :value nil, :category "Suppliers catalogue", :description "Nature: URL of web site with further details; Value: e.g. http://example.com", :type "String", :name "StratusLab.suppliers.catalog"}]}]})
