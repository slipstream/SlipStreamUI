...
(def xml-image-from-saas (first (html/html-snippet "<imageModule category='Image' creation='2013-12-02 17:00:37.421 UTC' deleted='false' description='Minimal installation of the Ubuntu 12.04 (LTS) operating system.' imageId='ami-a0dd3dd7' isBase='true' isLatestVersion='false' lastModified='2014-06-11 11:59:42.296 UTC' loginUser='ubuntu' logoLink='http://design.ubuntu.com/wp-content/uploads/ubuntu-logo14.png' parentUri='module/examples/images' platform='ubuntu' shortName='ubuntu-12.04' version='517'>
    <parameters>
        <entry>
            <string>instanceid</string>
    ...
    <authz groupCreateChildren='false' groupDelete='false' groupGet='true' groupPost='true' groupPut='false' inheritedGroupMembers='true' owner='super' ownerCreateChildren='true' ownerDelete='true' ownerGet='true' ownerPost='true' ownerPut='true' publicCreateChildren='false' publicDelete='false' publicGet='true' publicPost='true' publicPut='false'>
        <groupMembers/>
    </authz>
    <commit author='super'>
        <comment/>
    </commit>
    <published publicationDate='2014-06-11 11:59:42.296 UTC'/>
    <cloudNames length='3'>
