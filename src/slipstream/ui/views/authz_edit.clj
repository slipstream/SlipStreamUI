(ns slipstream.ui.views.authz-edit
  (:require [net.cgrand.enlive-html :as html]
            [slipstream.ui.models.authz :as authz-model]
            [slipstream.ui.models.module :as module-model]
            [slipstream.ui.views.authz :as authz]))

(html/defsnippet authz-view-snip authz/authorization-edit-template-html authz/authorization-view-sel
  [authz]
...
(html/defsnippet authz-edit-snip authz/authorization-edit-template-html authz/authorization-edit-sel
  [authz]
  [[:td (html/nth-of-type 2)] :input]
...
(html/defsnippet authz-delete-snip authz/authorization-edit-template-html authz/authorization-delete-sel
  [authz]
  [[:td (html/nth-of-type 2)] :input]
...
(html/defsnippet authz-post-snip authz/authorization-edit-template-html authz/authorization-execute-sel
  [authz]
  [[:td (html/nth-of-type 2)] :input]
...
(html/defsnippet authz-children-snip authz/authorization-edit-template-html authz/authorization-create-children-sel
  [authz]
  [[:td (html/nth-of-type 2)] :input]
...
(html/defsnippet authz-group authz/authorization-edit-template-html authz/authorization-inheritance-sel
  [authz]
  [[:td (html/nth-of-type 2)] :input]
  (authz/assign-checked authz-model/ownercreatechildren? authz)
  [[:td (html/nth-of-type 3)] :input]
...
(html/defsnippet authz-project-snip authz/authorization-edit-template-html authz/authorization-acl-sel
  [authz]
...
(html/defsnippet authz-inhertance-snip authz/authorization-edit-template-html authz/authorization-inheritance-sel
  [authz]
...
(html/defsnippet authz-snip authz/authorization-edit-template-html authz/authorization-sel
  [module]
