...
(expect
  "<script src=\"js/last.js\"></script><script src=\"js/support.js\"></script>"
...
(expect
  "<script src=\"js/blah.js\"></script><script src=\"js/last.js\"></script><script src=\"js/support.js\"></script>"
  (->> (@#'slipstream.ui.views.base/bottom-internal-scripts-snip ["blah.js"])
       html/emit*
       (apply str)))

(expect
  "<script src=\"js/foo.js\"></script><script src=\"js/foo/bar.js\"></script><script src=\"js/last.js\"></script><script src=\"js/support.js\"></script>"
